            ...
            children: <Widget>[
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text("扫二维码,转入(ETH)"),
                      SizedBox(height: 15,),
                      QrImage(data: Provider.of<Wallet>(context).currentWallet,size: 230,padding: EdgeInsets.all(0),),
                      SizedBox(height: 35,),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          ...
                          Text(TokenService.maskAddress(
                              Provider.of<Wallet>(context).currentWallet),style: TextStyle(fontSize: 12,color: MyColors.GRAY_TEXT_99),),
                        ],
                      ),
                    ],
                  ),
              ...
              Center(
                child: BaseButton().getBaseButton(text: "复制",img:"images/icon_btn_copy.png" ,width:315,onPressed: (){
                  Clipboard.setData(ClipboardData(text: Provider.of<Wallet>(context).currentWallet));
