...
// you-match: 0x199794aBADE0c68d4791961455C5A0FA7bBc74BD
  ...
  static const hotToken = [
    {
      'name': 'USDT',
      'address': '0x2d893f36d5dd233a9a8e2f6eebb807e6da331b7f',
...
//    }
  ...
  //质押的固定地址
  static String pledgeAddress = "0xae2d404e0f2c3ffd992f96ad8b9f055389f8b405";
  ...
  static const myKey = "v3/9ff09f1a3c284d28830665290dab81c5";
  ...
  static String getWSBaseUrl() {
    return "wss://" + getPrefs('network') + ".infura.io/" + myKey;
  }
